...
export class CuentaEmpleadoControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation cuentaEmpleadoControllerGetEmpleado
   */
  static readonly CuentaEmpleadoControllerGetEmpleadoPath = '/cuentas/{id}/empleado';
  ...
  getEmpleado$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CuentaEmpleadoControllerService.CuentaEmpleadoControllerGetEmpleadoPath, 'get');
    if (params) {
